...
## There are some repositories here which you can browse!
 - [This](/nornir) repo holds my resources on the fourse of [udemy](https://www.udemy.com/nornir-network-automation)
...
### Rundeck
 ...
 -[Rundeck - Adding windows node](https://youtu.be/iA59sS6Ab_A)
...
### Falcon
 ...
 -[Falcon - Linux Setup](https://youtu.be/5huWPPdiTAo)
...
### Octopus Deploy
 ...
 -[Octopus Deploy - Python module](https://youtu.be/Vh9Q8vCf2bc)
...
### Ansible
 ...
 - [Ansible - Variables and templates with apache](https://youtu.be/YPhRh8I3f44)
...
### Python - Bottle Web Framework
 - [Python - Setting up devpi server](https://youtu.be/Dxu3W7RkozU)
 ...
 - [Python - Bottle - Part 6](https://youtu.be/r-XdmZuxekI)
 - [Python - Bottle - Part 7](https://youtu.be/7wSXzBlPtQc)
 - [Python - Bottle - Part 8](https://youtu.be/HiOODZEsv-w)
 - [Python - Bottle - Part 9](https://youtu.be/DZGeG3Nex64)
 - [Python - Bottle - Part 10](https://youtu.be/poGtND8bnjE)
 - [Python - Bottle - Part 11](https://youtu.be/Y204i7RzktI)
 - [Python - Bottle - Part 12](https://youtu.be/JpTn7wi3naA)
...
### Python
 ...
 - [Python - NamedTouple from typing module](https://youtu.be/MT29HjOPCKE)
 - [Python - BeautifulSoup intro](https://youtu.be/zZe_-EzluZI)
 - [Python - 3.7.0 - Dataclasses demo](https://youtu.be/1K9i6Dor808)
 - [Python - Counter class from Collections module](https://youtu.be/m5J5vvGFuFg)
 - [Python - Requests module getting started](https://youtu.be/ZEO3BhdrGx0)
 - [Python - Confluence Backup](https://youtu.be/EoZbFjagYhk)
